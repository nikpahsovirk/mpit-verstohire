...
<div class="img-reg row">     
<?php
     if ($_COOKIE['user']==''):
?>
    <div class="col-sm" style=" padding-left:220px; padding-top:420px;">
        <a id="button-test" href="vhod.php">Войти</a>
    </div>
      <div class="reg-wrapper col-sm">
         <h1 class="authText">Создать аккаунт</h1><br>
           <form style="width:500px;" action="php/check.php" method="post">
